// Alpha-scoped on purpose — only Character sheets are in real use right now
// (see project_realtime_sync_state / board-initiative-dice-timer-state
// memory: Board and everything live is a separate, later rollout). Expand
// this page section-by-section as each new area actually goes live, rather
// than documenting features nobody can use yet.
export function HelpPage() {
  return (
    <div className="help-page">
      <h2>Help</h2>
      <p className="hint">
        This is an early alpha test — tonight, the character sheet is the only thing in real use.
        Everything below covers that.
      </p>
      ...
      <div className="sheet-section box">
        ...
        <p>
          Click <strong>+ Level Up</strong> at the top of your sheet. You only enter the new level
          and your hit dice roll for this level — the app adds your Constitution modifier and
      ...
      <div className="sheet-section box">
        ...
        <p>
          ...
          edit the number in any pill directly, same autosave-on-blur behavior as the rest of the
          sheet.
        </p>
      </div>
      ...
      <div className="sheet-section box">
        ...
        <p>
          <strong>Download PDF</strong> at the top of your sheet generates a print-ready character
          sheet with your current stats — handy to have offline or on your phone during the
          session.
        </p>
      </div>
      ...
      <div className="sheet-section box">
        ...
        <ul>
          ...
          <li>Board, live initiative, shop, maps, and notes aren't part of tonight's test.</li>
